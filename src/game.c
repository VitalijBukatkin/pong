...
void render_game(SDL_Renderer *ren, Ball ball, Player pl1, Player pl2) {
  ...
  apply_text_to_renderer(ren, fonts.main, TEXT_BUFF, pl1.pos.w + 10, pl1.pos.w,
                         TEXT_COLOR);
  sprintf(TEXT_BUFF, "%d", pl2.score);
  apply_text_to_renderer(ren, fonts.main, TEXT_BUFF,
                         SCREEN_WIDTH - pl2.pos.w - 20, pl2.pos.w, TEXT_COLOR);
...
void render_end_game(SDL_Renderer *ren, Player pl1, Player pl2) {
  ...
  apply_text_to_renderer(ren, fonts.main, TEXT_BUFF, (SCREEN_WIDTH / 2) - 150,
                         SCREEN_HEIGHT / 2, TEXT_COLOR);
  SDL_RenderPresent(ren);
}
